...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const nlpPatterns = {
        ...
        video: {
            ...
            <a href="videoADID.html#video-section" class="page-link"><i class="fas fa-play-circle"></i> Voir la vidéo</a>`
        },
        ...
        ressources: {
            ...
            <a href="videoADID.html#resources" class="page-link"><i class="fas fa-download"></i> Accéder aux ressources</a>`
        },
        ...
        enseignant: {
            ...
            <a href="videoADID.html#resources" class="page-link"><i class="fas fa-chalkboard-teacher"></i> Ressources enseignant</a>`
        },
        ...
        pageActuelle: {
            ...
            response: () => {
                const currentPage = window.location.pathname.split('/').pop() || 'videoADID.html';
                const pageInfo = {
                    'videoADID.html': { nom: 'Accueil', desc: 'la page principale avec la vidéo pédagogique' },
